//Balancing chemical equations coded by Nguyen Phuc Nguyen from 10TT-Ben Tre High School for Gifted Students
//NO COPYRIGHT
#include <bits/stdc++.h>
#define ll long long
using namespace std;
...
void elements(map<string,int>m)
{
    int n=0;
